<x-app-layout>
    ...
    <div class="text-white mt-20 mx-20 mb-40">
        ...
        <div class="text-2xl p-4 p-4">File Operations</div>
        ...
        <div class="text-2xl p-4">Steganography</div>
        ...
        <div class="text-2xl p-4">Forensics</div>
        ...
        <div class="text-2xl p-4">Directory and File Operations</div>
        ...
        <div class="text-2xl p-4">File Removal (rm)</div>
        ...
        <div class="text-2xl p-4">File Copying (cp)</div>
        ...
        <div class="text-2xl p-4">File Movement (mv)</div>
        ...
        <div class="text-3xl p-4">Linux File Permissions</div>
        ...
        <div class="text-2xl p-4">Changing Permissions (chmod)</div>
        ...
        <div class="text-2xl p-4">Changing Ownership (chown)</div>
        ...
        <div class="text-3xl p-4">Finding Files (find)</div>
        ...
        <div class="text-3xl p-4">Text Searching (grep)</div>
        ...
        <div class="text-3xl p-4">Downloading Files (wget)</div>

        <p>Download a specified file and change its save file name:</p>
        <div class="mockup-code">
            <pre
                data-prefix="$"><code>wget https://filesamples.com/samples/document/txt/sample1.txt -O new_name.txt</code></pre>
        </div>

        <div class="text-3xl p-4">Base64 Encoding and Decoding</div>
        ...
        <div class="mockup-code">
                    <pre
                        data-prefix="$"><code>echo -n 'VGV4dCB0aGF0IHdpbGwgYmUgYmFzZTY0IGVuY29kZWQ=' | base64 --decode</code></pre>
        </div>
        ...
        <div class="text-3xl p-4">Hashing</div>
        ...
        <div class="text-3xl p-4">Process Management</div>
        ...
        <div class="text-3xl p-4">Networking</div>
        ...
        <div class="text-3xl p-4">System Information</div>
