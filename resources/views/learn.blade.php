<x-app-layout>
    ...
    <div class="container mt-20 mx-auto px-4 sm:px-6 lg:px-8 text-white">
        <div class="text-5xl">CTF cheatsheet</div>

        <div class="text-4xl">Linux Basics</div>
        ...
        <ul class="list-disc list-inside ml-4">
            ...
            <li>List files in a website using a wordlist: <code>dirb &lt;target-website&gt; /path/to/wordlist.txt</code>
            </li>
        </ul>

        <h3 class="mt-4">Steganography</h3>

        <ul class="list-disc list-inside ml-4">
            <li>Hide a message in an image: <code>steghide embed -ef secret.txt -cf DSCN0042.jpg</code></li>
            <li>Extract a message from an image: <code>steghide extract -sf DSCN0042.jpg -xf secret_extract.txt</code>
            </li>
        </ul>

        <h3 class="mt-4">Forensics</h3>

        <ul class="list-disc list-inside ml-4">
            <li>binwalk: Use binwalk to analyze the file's contents and identify embedded files, hidden data, or
                appended archives. Run the following command to extract any embedded files <code>binwalk -e
                    filename</code></li>
            <li>Extract files with binwalk: <code>binwalk --dd='.*' file.pptm</code></li>
            <li>View EXIF data of a file: <code>exiftool filename</code></li>
        </ul>

        <h3 class="mt-4">Directory and File Operations</h3>
        ...
        <h3 class="mt-4">File Removal (rm)</h3>

        <ul class="list-disc list-inside ml-4">
            <li>Remove a file: <code>rm filename</code></li>
            <li>Remove an empty directory: <code>rm -d directory</code></li>
            <li>Remove a non-empty directory: <code>rm -rf</code></li>
        </ul>

        <h3 class="mt-4">File Copying (cp)</h3>
        ...
        <h3 class="mt-4">File Movement (mv)</h3>
        ...
        <h2 class="mt-8">Linux File Permissions</h2>

        <p class="mt-4">
            In Linux, each file is associated with an owner, a group, and permission access rights for three different
            classes of users: owner (user), group members (group), and everybody else (others). The following permission
            types apply to each class:
        </p>
        ...
        <p class="mt-4">
            The permissions number of a specific user class is represented by the sum of the values of the permissions
            for that group:
        </p>
        ...
        <p class="mt-4"><code>&lt;owner permissions&gt;&lt;group permissions&gt;&lt;others permissions&gt;</code></p>

        <p class="mt-4">
            For example, to set read, write, and execute permissions for the owner, read and write permissions for the
            group, and read permissions for everybody else, use the value <code>764</code>.
        </p>

        <h3 class="mt-4">Changing Permissions (chmod)</h3>

        <ul class="list-disc list-inside ml-4">
            <li>Change permissions of a file: <code>chmod 600 new_file.txt</code></li>
        </ul>

        <h3 class="mt-4">Changing Ownership (chown)</h3>

        <ul class="list-disc list-inside ml-4">
            <li>Change ownership of a file: <code>chown username filename.txt</code></li>
        </ul>

        <h2 class="mt-8">Finding Files (find)</h2>
        ...
        <h2 class="mt-8">Text Searching (grep)</h2>
        ...
        <h2 class="mt-8">Downloading Files (wget)</h2>

        <ul class="list-disc list-inside ml-4">
            <li>Download a specified file and change its save file name: <code>wget
                    https://filesamples.com/samples/document/txt/sample1.txt -O new_name.txt</code></li>
        </ul>

        <h2 class="mt-8">Base64 Encoding and Decoding</h2>

        <ul class="list-disc list-inside ml-4">
            <li>Encode text to Base64: <code>echo -n 'Text that will be base64 encoded' | base64</code></li>
            <li>Multiple rounds of Base64 encoding: <code>echo -n 'Text that will be base64 encoded' | base64 |
                    base64</code></li>
            <li>Decode Base64 to text: <code>echo -n 'VGV4dCB0aGF0IHdpbGwgYmUgYmFzZTY0IGVuY29kZWQ=' | base64
                    --decode</code></li>
            <li>Multiple rounds of Base64 decoding: <code>echo -n
                    'VkdWNGRDQjBhR0YwSUhkcGJHd2dZbVVnWW1GelpUWTBJR1Z1WTI5a1pXUT0K' | base64 -d | base64 -d</code> (can
                be shortened to <code>-d</code>)
            </li>
            <li>Decode Base64 to text with multiple rounds: <code>echo -n </li>
</x-app-layout>
